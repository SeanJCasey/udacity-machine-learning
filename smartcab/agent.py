...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1, alpha=0.5):
        ...
        self.trial_number = 0 # Create a trial counter
    ...
    def choose_action(self, state):
        ...
        if not self.learning or random.uniform(0, 1) < self.epsilon:
            ...
            # Create list of actions that have maxQ value. Impt so we don't always chose the first option in the dict.
            maxQ_actions = []
